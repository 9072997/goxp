...
var verifyTests = []verifyTest{
	...
	},
	{
		...
		name:          "SHA-384",
		leaf:          sectigoLeaf,
		intermediates: []string{sectigoSHA384Intermediate},
		roots:         []string{sectigoRootE46},
		currentTime:   1788307200,
		dnsName:       "github.com",
...
const sectigoRootE46 = `-----BEGIN CERTIFICATE-----
...
const sectigoSHA384Intermediate = `-----BEGIN CERTIFICATE-----
...
const sectigoLeaf = `-----BEGIN CERTIFICATE-----
